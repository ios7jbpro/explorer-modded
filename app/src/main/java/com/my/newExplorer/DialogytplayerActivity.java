	...
	public void _translate () {
		if (s.getString("language", "").equals("english")) {
			...
			if (s.getString("language", "").equals("persian")) {
				textview5.setText("دانلود");
				textview7.setText("تازه سازی ویدیو");
				textview8.setText("درحال بارگذاری");
				textview9.setText("بازکردن در YouTube");
				textview10.setText("اشتراک گذاری");
				textview11.setText("حالت PIP");
			}
			else {
				if (s.getString("language", "").equals("china")) {
					textview5.setText("下载");
					textview7.setText("重新加载视频");
					textview8.setText("载入中");
					textview9.setText("在 YouTube 中打开");
					textview10.setText("分享");
					textview11.setText("画中画模式");
				}
				else {
